<?php
	...
	if($stmt->rowCount()>0){
		while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
			...
			$stressDefenceValue=$objT->getStressDefence($userCode);
			...
			if($objE->isExist($userCode)===false){
				...
				$objE->burnouteRate = 0;
				$objE->burnouteGrade = getBurnoutGrade(0);
				...
				$objE->defenseStressRate = $stressDefenceValue;
				$objE->defenseStressGrade = getDefenceStressGrade($stressDefenceValue);
