...
function validInput(){
		var flag=true;
		flag=regDec.test($("#obj_choiceNo").val());
		if (flag==false){
			$("#obj_choiceNo").focus();
			return flag;
}
...
function displayData(){
		var url="tqlabel/displayData.php?tableName=t_qlabel&dbName=dbquestionair&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tqlabel/create.php';
		jsonObj={
...
function readOne(id){
		var url='tqlabel/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
