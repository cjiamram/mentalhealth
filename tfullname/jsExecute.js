...
function displayData(){
		var url="tfullname/displayData.php?tableName=t_fullname&dbName=dbimprovement&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tfullname/create.php';
		jsonObj={
...
function readOne(id){
		var url='tfullname/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
...
function confirmDelete(id){
		...
		if (willDelete.value) {
			url="tfullname/delete.php?id="+id;
