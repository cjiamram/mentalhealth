...
function displayStressPie() {
 var url="<?=$rootPath?>/report/getStudentStress.php?departmentCode=<?=$departmentCode?>";
 ...
 if(data!==undefined){
        ...
        var chart = new CanvasJS.Chart("pieStudentStress", {
          exportEnabled: true,
...
<div id="pieStudentStress" style="height: 400px; max-width: 800px; margin: 0px auto;"></div>
