...
function displaySuicidePie() {
 var url="<?=$rootPath?>/report/getStudentSuicide.php?departmentCode=<?=$departmentCode?>";
 ...
 if(data!==undefined){
        ...
        var chart = new CanvasJS.Chart("pieStudentSuicide", {
          exportEnabled: true,
...
<div id="pieStudentSuicide" style="height: 400px; max-width: 800px; margin: 0px auto;"></div>
