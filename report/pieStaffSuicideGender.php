...
function displayPie() {
 ...
 if(data!==undefined){
        ...
        var chart = new CanvasJS.Chart("pieSuicideGender", {
          exportEnabled: true,
          animationEnabled: true,
          title:{
            text: "สัดส่วนระดับการมีแนวโน้มการฆ่าตัวตาย <?=$levelName?>",
            fontFamily:"tahoma",
            fontSize:16,
            fontWeight: "bold"
          },
...
<div id="pieSuicideGender" style="height: 400px; max-width: 800px; margin: 0px auto;"></div>
