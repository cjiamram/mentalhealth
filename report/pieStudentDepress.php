...
function displayDepressPie() {
 var url="<?=$rootPath?>/report/getStudentDepress.php?departmentCode=<?=$departmentCode?>";
 ...
 if(data!==undefined){
        ...
        var chart = new CanvasJS.Chart("pieStudentDepress", {
          exportEnabled: true,
...
<div id="pieStudentDepress" style="height: 400px; max-width: 800px; margin: 0px auto;"></div>
