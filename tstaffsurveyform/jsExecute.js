...
function displayData(){
		var url="tstaffsurveyform/displayData.php?tableName=t_staffsurveyform&dbName=dbquestionair&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tstaffsurveyform/create.php';
		jsonObj={
...
function updateData(){
		var url='tstaffsurveyform/update.php';
		jsonObj={
			userCode:$("#obj_userCode").val(),
			projectGroupId:$("#obj_projectGroupId").val(),
			contactPerson:$("#obj_contactPerson").val(),
...
function readOne(id){
		var url='tstaffsurveyform/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
			...
			$("#obj_staffType").val(data.staffType);
...
function confirmDelete(id){
		...
		if (willDelete.value) {
			url="tstaffsurveyform/delete.php?id="+id;
