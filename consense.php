...
<div class="flex-container">
            <div class="modal-footer">
                    <input type="button" id="btnDecline" value="ปฏิเสธ"  class="btn btn-default pull-left" data-dismiss="modal">
                    <input type="button" id="btnAccept" value="ยอมรับ"  class="btn btn-primary" data-dismiss="modal">
              </div>
</div>
